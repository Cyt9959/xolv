...
class ProfilePage extends StatelessWidget {
        ...
        child: Column(
          children: [
                  ...
                  Container(
                    ...
                    child: CircleAvatar(
                      ...
                      child: user?.photoURL == null
                          ? Text(
                              (user?.displayName ?? "X").substring(0, 1).toUpperCase(),
                              style: const TextStyle(fontSize: 48, fontWeight: FontWeight.w600, color: accentColor),
                            )
                          : null,
                    ),
                  ),
            ...
            Text(
              ...
              style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w700, color: primaryTextColor, letterSpacing: -0.5),
            ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  _buildMenuTile(context, Icons.person_outline, "编辑资料", primaryTextColor),
                  _buildMenuTile(context, Icons.shield_outlined, "账号与安全", primaryTextColor),
                  _buildMenuTile(context, Icons.assignment_turned_in_outlined, "我的互助委托", primaryTextColor),
                  _buildMenuTile(context, Icons.help_outline_rounded, "帮助中心", primaryTextColor),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(
            text,
            style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Color(0xFF0D9488)),
          ),
        ],
      ),
    );
  ...
  Widget _buildMenuTile(BuildContext context, IconData icon, String title, Color color, {VoidCallback? onTap}) {
    return ListTile(
      ...
      trailing: const Icon(Icons.arrow_forward_ios, color: Color(0xFFD0D5DD), size: 16),
      onTap: onTap ?? () {},
    );
  }
}